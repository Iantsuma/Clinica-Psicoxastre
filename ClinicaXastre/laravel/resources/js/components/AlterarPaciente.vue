<template>
  <div class="container">
    <div class="row">
      <div class="col">
        <h1 class="logo">Edição de Pacientes</h1>
        <form @submit.prevent="submitForm">
          ...
          <div class="form-group">
            <input type="submit" class="btn btn-um" value="Salvar">
          </div>
          <hr>
        </form>
      </div>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      ...
      .then(() => {
        window.location.href = '/psicologa/ficha'; // ou o caminho correto da sua rota home
      })
      .catch(error => {
